...
$start=($strana-1)*5;
$end=($strana)*5;
$query1 = "SELECT COUNT(*) FROM podaci WHERE (".$a1.") AND odobren LIKE '1' AND tip_unosa NOT LIKE 'istorija' AND tip_unosa NOT LIKE 'tesla'  AND tip_unosa NOT LIKE 'projekat' ORDER BY ".$sort." DESC ";
...
if ($ukupno!=0){
	...
	$query = "SELECT * FROM podaci WHERE (".$a1.") AND odobren LIKE '1' AND tip_unosa NOT LIKE 'istorija' AND tip_unosa NOT LIKE 'tesla' AND tip_unosa NOT LIKE 'projekat' ORDER BY ".$sort." DESC LIMIT $start, 5 ";
	...
	while ($z = mysql_fetch_assoc($rez)) {
		...
		$q1 = "SELECT * FROM ".$baza." WHERE  pod_ID = '$pod_ID' ";
		...
		echo "<span class=\"naslov\"><a class=\"naslov\" href=\"".$link."$pod_ID\">".$z1['naslov']."</a></span>";
